...
class DeploymentPaths:
    ...
    mutation_sudoers_path: Path = Path("/etc/sudoers.d/cloudflared-manager-mutation-bridge")
    ...
    @property
    def mutation_helper_path(self) -> Path:
        return self.install_root / "privileged-mutation-helper"
